...
// Graph.h, but the edge "weights" are strings describing the connection.
...
public:    
   ...
   Edge* AddDirectedEdge(Vertex* fromVertex, Vertex* toVertex, std::string weight="->") {

...
void question_3(){
    ...
    cout << "We begin with your character standing at the mouth of a great cave. Please choose between choice [1] (enter the cave) or choice [2] (walk away to begin)." << endl;
    cin >> choice;
